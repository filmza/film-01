...
cl = LINETCR.LINE()
cl.login(token="EsZ3xpmhHKfGWfBm9nAf.uZ/v/domroIuacOdOXTQ3W.xgA+Kh1YPipM7vQvQaRFC4r+xseR/RowDC7rW8wUQhs=")
cl.loginResult()
...
#k4mid = k4.getPr0ofile().mid
#k5mid = k5.getProfile().mid
Bots = ["u533f95f8338c44e894002a03a31b6adf",mid]
bot1 = cl.getProfile().mid
admsa = "u533f95f8338c44e894002a03a31b6adf"
admin = "u533f95f8338c44e894002a03a31b6adf"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u533f95f8338c44e894002a03a31b6adf":
                    if "join:" in msg.text:
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ASUL BOT BY:➢ชินจัง❖ざചีஞ❶➢")

            elif cms(msg.text,["ผู้สร้าง","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendText(msg.to,"􀜁􀇔􏿿 ASUL BOT BY:➢ชินจัง❖ざചีஞ❶➢ 􀜁􀇔􏿿 ")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀜁􀇔􏿿 http://line.me/ti/p/~chindo321 􀜁􀇔􏿿 ")
